        ...
        <div class="grid gap-12 lg:grid-cols-12 lg:items-center">
            <div class="relative order-2 lg:order-1 lg:col-span-5" data-tilt>
                <figure class="img-frame aspect-[3/4]">
                    <img src="{{ asset(siteSetting('coffee_philosophy', 'image.src')) }}" alt="{{ siteSetting('coffee_philosophy', 'image.alt') }}" width="800" height="1067" loading="lazy" decoding="async">
                </figure>
                <span class="vert absolute -right-4 top-0 hidden font-mono text-[0.6rem] uppercase tracking-[0.3em] text-paper/50 lg:block" data-reveal>
                    {{ siteSetting('coffee_philosophy', 'mono') }}
                </span>
            </div>

            <div class="order-1 lg:order-2 lg:col-span-6 lg:col-start-7">
                <span class="font-mono text-[0.62rem] uppercase tracking-[0.26em] text-wood" data-reveal>{{ siteSetting('coffee', 'label') }} / 02</span>
                <blockquote class="mt-10 font-display text-[clamp(2rem,5.5vw,4.6rem)] leading-[1.02]">
                    <span class="reveal block" data-reveal>“{{ siteSetting('coffee_philosophy', 'quote') }}”</span>
                </blockquote>
                <p class="mt-8 text-[0.95rem] leading-relaxed text-paper/70" data-reveal style="--d: 0.15s">
                    {{ siteSetting('coffee_philosophy', 'sub') }}
                </p>
